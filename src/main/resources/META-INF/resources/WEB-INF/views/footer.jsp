<footer>
    <div class="container-fluid ">
        <div class="row font-color" style="background-color: black;padding-top: 20px;padding-left: 30px;padding-bottom: 1px;">
            <div class="col-sm-4">
                <h6>Quick Links</h6>
                <a href="/home" class="font-color link">Home</a><br>
                <a href="/bookmark" class="font-color link">Bookmark</a><br>
                <a href="/contact" class="font-color link">Contact</a><br>
                <a href="/profile" class="font-color link">Profile</a>
                <a href="/logout" class="font-color link">Logout</a>
            </div>
            <div class="col-sm-4">
                <h6>Contuct Us</h6>
